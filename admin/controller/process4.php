<?php 
include '../model/mydb4.php';

$name=$email=$pass=$gender=$birth=$nmbr=$haserror="";
$nameError=$emailError=$passError=$genderError=$birthError=$nmbrError="";
...
if(isset($_REQUEST["SUBMIT"]))
{
  ...
  if($haserror!=1)
  {
    ...
    $_REQUEST["email"], $_REQUEST["pass"], $_REQUEST["gender"],$_REQUEST["birth"],$_REQUEST["nmbr"]);
